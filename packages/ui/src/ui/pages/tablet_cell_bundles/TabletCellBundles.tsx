...
import {TabletErrors} from '../../pages/tablet-errors/TabletErrors';
...
export default function TabletCellBundles() {
    ...
    errorsTab.show = errorsTab.show && getConfigData().allowTabletErrors;
            ...
            <section className={b(null, 'elements-main-section')}>
                ...
                <div className={b('tab-viewer')}>
                    <Switch>
                        ...
                        {errorsTab.show && <TabletErrors bundle={activeBundle} />}
                        <Route
